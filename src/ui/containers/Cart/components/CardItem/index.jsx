  ...
  render() {
    ...
    return [
      ...
      <tr key="2" {...props} ref={ref => (this.element = ref)}>
          ...
          <Link to={`/${outlet_slug}/${item_slug}`}>
            <div className="d-flex flex-row">
              ...
              <div className="w-100 ml-4">
                <div className="your-cart-item-name d-flex align-items-end font-fr-130 color-cg-040 text-uppercase">
                  <span>{title}</span>
                </div>
        ...
        <td
          className="font-fr-130 color-cg-074"
          data-title={t("TABLE.UNIT_PRICE")}
        >
        ...
        <td
          className="text-right color-red font-fr-130"
          data-title={t("TABLE.TOTAL")}
        >
          {t("format.currency", {
            price: total * (1 - vat),
            symbol: priceUnit
        ...
        <td className="text-right" data-title={t("TABLE.DELETE")}>
          <i
            role="button"
            onClick={onRemove}
            className="fa fa-times font-fr-130"
            aria-hidden="true"
          />
        </td>
      </tr>
